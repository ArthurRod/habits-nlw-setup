...
import { AVAILABLE_WEEK_DAYS } from "../constants/availableWeekDays";
  ...
  return (
    ...
    >
      ...
      <div className="mt-3 flex flex-col gap-2">
        {AVAILABLE_WEEK_DAYS.map((weekDay, i) => {
          return (
            <Checkbox.Root
              key={weekDay}
      ...
      <button
        type="submit"
        disabled={weekDays.length === 0 || title.length === 0}
        className="mt-6 rounded-lg p-4 flex items-center justify-center gap-3 font-semibold disabled:cursor-not-allowed bg-green-600 hover:bg-green-500 disabled:opacity-60 transition-colors focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-zinc-900"
      >
